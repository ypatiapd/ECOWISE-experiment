...
class flowControl():
    ...
    def stage_2(self):
        ...
        self.master.measurements["Press"]=30
        ...
        self.pump.toff_pump() # vale flow logger kai ta upoloipa
        print("i antlia ekleise")
    ...
    def check_command_vector(self):
        ...
        elif  self.master.commands['TON_H1'] == 1:
            GPIO.output(16, GPIO.HIGH)
            self.flow_info_logger.write_info("Command TON_H1 Successfuly turned on heater 1")
            self.master.status['heater1'] = 1
            return 0

        elif  self.master.commands['TOFF_H1'] == 1:
            GPIO.output(16, GPIO.LOW)
            self.flow_info_logger.write_info("Command TOFF_H1 Successfuly turned off heater 1")
            self.master.status['heater1'] = 0
            return 0

        elif  self.master.commands['TON_H2'] == 1:
            GPIO.output(17, GPIO.HIGH)
            self.flow_info_logger.write_info("Command TON_H2 Successfuly turned on heater 2")
            self.master.status['heater2'] = 1
            return 0

        elif  self.master.commands['TOFF_H2'] == 1:
            GPIO.output(17, GPIO.LOW)
            self.flow_info_logger.write_info("Command TOFF_H2 Successfuly turned off heater 2")
