...
class test_data:
    ...
    def read_GPS(self):
        ...
        lattitude,longtitude,altitude=self.gps.read_data()
    ...
    def log_data(self):
        ...
        self.gps_logger.write_info(format(self.master.measurements["Gps_Time"]))
        self.O3_1_logger.write_info(format(self.master.measurements["O3_1"]))
        self.O3_2_logger.write_info(format(self.master.measurements["O3_2"]))
        self.CO2_1_logger.write_info(format(self.master.measurements["CO2_1"]))
        self.CO2_2_logger.write_info( format(self.master.measurements["CO2_2"]))
        ...
        '/'+format(self.master.measurements["Out_Hum"])+'/'+format(self.master.measurements["In_Press"])+'/'+format(self.master.measurements["Pump_Temp"])+'/'+format(self.master.measurements["SB_Temp"])+
        '/'+format(self.master.measurements["Gps_X"])+'/'+format(self.master.measurements["Gps_Y"])+'/'+format(self.master.measurements["Gps_altitude"])+'/'+format(self.master.measurements["In_Press"])+
        '/'+format(self.master.measurements["O3_1"])+'/'+format(self.master.measurements["O3_2"])+'/'+format(self.master.measurements["CO2_1"])+'/'+format(self.master.measurements["CO2_2"])+'/'+format(self.master.measurements["Data_acq"])
